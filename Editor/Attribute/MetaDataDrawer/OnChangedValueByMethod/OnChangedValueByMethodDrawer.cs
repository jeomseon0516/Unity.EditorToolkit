...
namespace Jeomseon.Attribute.Editor
{
    ...
    /// <summary>
    /// OnChangedValueByMethodAttribute를 처리하는 전역 핸들러입니다.
    /// InspectorWindow 내부 구조를 건드리지 않고 Editor.finishedDefaultHeaderGUI 공식 API로 동작합니다.
    /// TODO(리팩토링): 헤더가 다시 그려질 때 값을 폴링하는 방식 대신 Undo.postprocessModifications와
    /// SerializedObject 변경 추적을 조합해 실제 직렬화 변경 시점에만 호출하도록 개선해야 합니다.
    /// </summary>
    [InitializeOnLoad]
